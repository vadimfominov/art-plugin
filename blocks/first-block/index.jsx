		...
		return [
			...
			<div {...blockProps}>
				...
				<div className="wrapper">
					{inActiveLabel && <div class="label-card-first-block">АРТ Личность расширяется: этим летом мы открываем <a href="https://msk.art-lichnost.ru/#filter" >лагерь в Москве.</a></div>}
