...
const catIcon = (<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
	...
	registerBlockType("fv/program-modal-with-city", {
		title: 'Заявка на программу с городом',
		icon: catIcon,
		category: 'common',
		keywords: ['Заявка на программу с городом', 'фке', 'art'],
		attributes: {
			title: {
				type: 'string',
				default: ''
							...
							<div className={'step step-1 fronted'}>
								...
								<div className={'city-checkbox'}>
									<label className={'checkbox'}>
										<input type={'radio'} name={'city'} value="Москва" aria-label={'Москва'} />
										<span className={'title'}>Москва</span>
									</label>
									<label className={'checkbox'}>
										<input type={'radio'} name={'city'} value="Санкт-Петербург" aria-label={'Санкт-Петербург'} />
										<span className={'title'}>Санкт-Петербург</span>
									</label>
								</div>
