			...
			<div {...blockProps}>
				<div className="wrapper">
					...
					{vk && <div className={'first-item'}>
						...
						// allowedFormats={[]}
						/>
						<a href={'https://vk.com/' + vk} target={'_blank'} area-label={'vk'} className={'vk-contacts'}>Перейти в ВК <span>{iconVk}</span> </a>
						{
							!image1 || !image1.url ?
								<MediaUpload
									onSelect={(media) => {
					...
					{tg && <div className={'last-item'}>
						...
						<a href={'https://t.me/' + tg} target={'_blank'} area-label={'tg'} className={'tg-contacts'}>Перейти в TG <span>{iconTg}</span></a>
						{
							!image2 || !image2.url ?
								<MediaUpload
									onSelect={(media) => {
