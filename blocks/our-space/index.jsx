(function (wp) {
	...
	registerBlockType("fv/our-space", {
		title: 'Наше пространство',
		icon: catIcon,
		category: 'common',
		keywords: ['Наше пространство', 'фке', 'art'],
		attributes: {
			title: {
				type: 'string',
				default: ''
	...
	function Edit(props) {
		...
		// 							{ blocksData[index]?.image  ? <img src={imageURL} alt={'photo'} width={"100%"} height={"auto"} /> 
		// 								: 'Выбрать картинку' }
		// 						</Button>
		// 					)}
		// 				/>
		...
		const updateCaption = (index, key, caption) => {
			const newGallery = [...gallery];
			newGallery[index][key] = caption;
			...
			<div {...blockProps}>
				<div className="wrapper">
					...
					<div className={'container'}>
						<div className={'left-map'} id={'map'}></div>
						<div className={'slider-container'}>
							...
							<div className={'slider-box'}>
								<ul className={'slider-space slider-block'}>
							...
							<ul className={'slider-space-thumbnail'}>
							...
							<div className={'slider-space-pagination-btns slider-pagination'}>
	...
	function Save(props) {
		const { attributes: { title, description, gallery }, className } = props;
