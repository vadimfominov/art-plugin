(function (wp) {
	...
	const SHIFT_OPTIONS = [
		...
		{ label: 'Родительская среда', value: 'parent-wednesdays' }
	];
	function Edit(props) {
		const {
			attributes: {
		...
		return [
			...
			<div {...blockProps} id={anchor}>
				<div className={"wrapper"}>
					...
					/>
					{(isSelected || description2) && <div className={'back-block'}>
						<RichText
							tagName="p"
					...
					<div className={'container-filter'}>
						...
						<div className={'result-content-filter'}>
							<div id={"filtered-posts-container"} style={{minHeight: '200px'}}></div>
