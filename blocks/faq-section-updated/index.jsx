(function (wp) {
	...
	registerBlockType("fv/faq-section-updated", {
		apiVersion: 3,
		title: 'Ответы на вопросы мск',
		icon: catIcon,
		category: 'common',
		keywords: ['Ответы на вопросы мск', 'faq', 'фке', 'art'],
		attributes: {
			title: {
				type: 'string',
				default: ''
	...
	function Save(props) {
		const { title, description, blocksData, blocksData2, listItems, inBlock } = props.attributes;
		if (!inBlock) {
			return null;
		}
