(function (wp) {
	...
	const { InspectorControls, MediaUpload, useBlockProps, InnerBlocks} = wp.blockEditor;
	...
	registerBlockType("fv/suitable-child", {
		apiVersion: 3,
		title: 'Подойдёт ребёнку',
		icon: catIcon,
		category: 'common',
		keywords: ['Подойдёт ребёнку', 'suitable-child', 'фке', 'art'],
		attributes: {
			title: {
				type: 'string',
				default: ''
		...
		return [
			...
			<div {...blockProps}>
				<div className="wrapper">
					...
					/>
					<div className={'container-suitable-child'}>
						...
						<div className="left-suitable-child">
							<RichText
								tagName="p"
						...
						<div className="right-suitable-child">
