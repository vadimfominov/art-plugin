(function (wp) {
	...
	registerBlockType('fv/family-values-copy', {
		title: 'family values copy',
		icon: catIcon,
		category: 'common',
						...
						<div className={'container-family'}>
							...
							<div className={'item'}>
								<RichText
									...
									onChange={(value) => setAttributes({ title1_1: value })}
									value={title1_1}
									placeholder="Заголовок..."
									// allowedFormats={[]}
								/>
					...
					<div className={'container-block-family'}>
						...
						<div className={'container-family'}>
							<div className={'item'}>
								...
								{title1_1 && <RichText.Content className={'title-item'} tagName="span" value={title1_1} />}
